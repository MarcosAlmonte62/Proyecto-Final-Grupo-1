...
public class StatsEquipo implements Serializable {
	...
	public void actualizarStats(int dobles, int rebotes, int asistencias, int robos, int tapones, int tirosLibres,
			int tirosLibresAcert, int triples) {
		this.dobles += dobles;
		this.rebotes += rebotes;
		this.asistencias += asistencias;
		this.robos += robos;
	...
	public void actualizarStats(int dobles, int rebotes, int asistencias, int robos, int bloqueos, int tirosLibres,
			int tirosLibresAcert, int triples, int puntos) {
		this.dobles += dobles;
		this.rebotes += rebotes;
		this.asistencias += asistencias;
		this.robos += robos;
		this.tapones += bloqueos;
		this.tirosLibres += tirosLibres;
		this.tirosLibresAcert += tirosLibresAcert;
		this.triples += triples;
		this.puntos += puntos;
	...
	public void registrarVictoria(int puntosAFavor, int puntosEnContra) {
		this.victorias++;
		this.puntos += puntosAFavor;
		this.puntosContra += puntosEnContra;
		this.setPuntuacion(this.getPuntuacion() + 3); // 3 puntos por victoria
	}

	public void registrarDerrota(int puntosAFavor, int puntosEnContra) {
		this.derrotas++;
		this.puntos += puntosAFavor;
		this.puntosContra += puntosEnContra;
	}
