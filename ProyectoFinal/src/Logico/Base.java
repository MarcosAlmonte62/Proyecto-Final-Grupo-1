...
public class Base extends Atacante{
	...
	public Base(String nombre, int edad, String nacionalidad, Lesion lesion, Equipo equipo, int dorsal, int puntos,
			int asistencias, int tiros, int perdidas, int triples, int tripleDoble) {
